class RecommendationsController < ApplicationController
  ...
  def new
    ...
    @courses = Course.pluck(:catalognumber)
    if params[:course_id]
      @section = Course.find(params[:course_id]).sections.find(params[:id])
    else
      @section = []
    end
  end
  ...
  private
    ...
    def recommendation_params
      params.require(:recommendation).permit(:student_firstname, :student_lastname, :student_email, :course_index, :course_section, :reasons)
    end
end
