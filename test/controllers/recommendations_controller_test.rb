...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference("Recommendation.count") do
      post recommendations_url, params: { recommendation: { course_index: @recommendation.course_index, course_section: @recommendation.course_section, reasons: @recommendation.reasons, student_email: @recommendation.student_email, student_firstname: @recommendation.student_firstname, student_lastname: @recommendation.student_lastname } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { course_index: @recommendation.course_index, course_section: @recommendation.course_section, reasons: @recommendation.reasons, student_email: @recommendation.student_email, student_firstname: @recommendation.student_firstname, student_lastname: @recommendation.student_lastname } }
